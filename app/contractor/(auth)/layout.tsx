...
// Mirrors app/(auth)/layout.tsx exactly -- same centered-logo shell, just
// under /contractor so contractor sign-in/up gets its own public URLs.
    ...
    <>
      ...
      >
        <Link href="/" className="logo" style={{ textAlign: "center" }}>
          ...
          <span className="logo-tag">FOR CONTRACTORS</span>
        </Link>
        {children}
      </div>
    </>
